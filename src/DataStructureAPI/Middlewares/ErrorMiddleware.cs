...
namespace DataStructureAPI.Middlewares
{
    public class ErrorMiddleware : IMiddleware
    {
        ...
        {
            _logger.LogError($"error message:{exception.Message} date:{DateTime.Now}");
            context.Response.ContentType = "application/json";
            context.Response.StatusCode = (int)statusCode;
            await context.Response.WriteAsJsonAsync(new { ErrorMessage = exception.Message, ErrorCode = (int)statusCode });
        }
    }
}